...
from retector.securify2.grammar import Grammar, DerivationTree, production
...
class AttributeGrammar(Grammar):
    ...
    def __init__(self, classes,
        ...
        from retector.securify2.grammar.attributes.dependencies import AttributeDependenceRelations
